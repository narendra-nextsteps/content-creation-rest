...
from content_creation_db.api_queries.get_topic_details import \
    get_topic_details_query_response
from google.protobuf import json_format

POST_REQUEST = 'POST'
GET_TOPIC_DETAILS_API = '/get-topic-details'
...
class GetTopics(Resource):
    ...
    def post(self):
        ...
        msg_request, err_msg = flask_request_response.message_request(
            request_pb2.GetTopics, GET_TOPIC_DETAILS_API, POST_REQUEST
        )
        ...
        try:
            ...
            query_response = get_topic_details_query_response(
                json_request['ids'])
            return query_response
        except Exception as err:
            return flask_request_response.error_response(
                str(err), GET_TOPIC_DETAILS_API, POST_REQUEST
            )
